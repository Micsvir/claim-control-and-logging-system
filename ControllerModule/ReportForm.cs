...
namespace ControllerModule
{
    public partial class ReportForm : Form
    {
        ...
        {
            InitializeComponent();
            MainForm.getReportColumnsRequest = true;
            try
            {
                ...
                CreateDGVColumns(dgvReport, MainForm.receivedData);
            ...
            MainForm.getReportColumnsRequest = false;
        }
        ...
        public void SetDefaultParameters()
        {
            ...
            dgvParametersSelection.Rows[0].Cells[0].Value = "Контролер";
            dgvParametersSelection.Rows[0].Cells[1].Value = "LIKE";
            dgvParametersSelection.Rows[0].Cells[2].Value = MainForm.currentUserData.Rows[0]["PersLastName"].ToString();
            ...
            dgvParametersSelection.Rows.Add();
            dgvParametersSelection.Rows[3].Cells[0].Value = "Дата";
            dgvParametersSelection.Rows[3].Cells[1].Value = "=";
            dgvParametersSelection.Rows[3].Cells[2].Value = year + "." + month + "." + day;
        ...
        {
            MainForm.viewReportButtonClicked = true;
